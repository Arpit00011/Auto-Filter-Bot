...
from utils import get_size, extract_tag, is_subscribed, pub_is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings, get_shortlink, get_tutorial, send_all, get_cap
...
async def advantage_spell_chok(client, name, msg, reply_msg, nam_search):
    ...
    if AI_SPELL_CHECK == True and nam_search == True:
        ...
        nam_ai_msg = await reply_msg.edit_text("<b><i>Advance Ai Trying To Find Your Movie With Your Wrong Spelling.</i></b>")
        movienamelist = []
